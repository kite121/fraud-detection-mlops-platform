...
def create_training_job(
    *,
    ...
    try:
        prefix = "retrain" if job_type == "retraining" else "train"

        entry = TrainingJob(
            job_id=_generate_job_id(prefix),
            job_type=job_type,
            batch_id=batch_id,
...
def mark_job_completed(
    ...
    *,
    ...
    """Marks a job as completed and stores the resulting model metadata when available."""
