...
@celery_app.task(bind=True, name="workers.retraining_worker.retrain_model_task")
def retrain_model_task(
    ...
    try:
        with tracer.start_as_current_span("retrain_model_task") as span:
            ...
            with tracer.start_as_current_span("train_model"):
                training_result = train_model(prepared, run_name="retraining_run")
            ...
            registered = register_model_version(
                ...
                notes=f"Retraining job {job_id}: {reason}",
